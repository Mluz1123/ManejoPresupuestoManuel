...
namespace ManejoPresupuesto.Servicios
{
    ...
    {
        Task<IEnumerable<ResultadoOptenerPorSemana>> ObtenerReporteSemanal(int usuarioId, int mes, int año, dynamic ViewBag);
    ...
    public class ServicioReportes: IServicioReportes
    {
        ...
        public async Task<IEnumerable<ResultadoOptenerPorSemana>> ObtenerReporteSemanal(int usuarioId,int mes, int año, dynamic ViewBag)
        {
            ...
            var modelo = await repositorioTransacciones.OptenerPorSemana(parametro);
            return modelo;
        }
